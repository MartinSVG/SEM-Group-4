...
public class App
{
    ...
    public void printAllCities(ArrayList<City> cities)
    {
        // Print header
        System.out.println("-------------------------------------------------------------------------------------------------");
        System.out.println(String.format("%-35s %-18s %-25s %-15s", "City Name", "Country Code", "District", "Population"));
        System.out.println();
        System.out.println("-------------------------------------------------------------------------------------------------");
    ...
    public void printCityContinent(ArrayList<City> cityContinent)
    {
        // Print header
        System.out.println("-------------------------------------------------------------------------------------------------");
        System.out.println(String.format("%-15s %-15s %-18s %-25s %-15s", "Continent", "Country Code","City Name", "District", "Population"));
        System.out.println();
        System.out.println("-------------------------------------------------------------------------------------------------");
        // Loop over all cities in the list
    ...
    public void printCityRegion(ArrayList<City> cityRegion)
    {
        // Print header
        System.out.println("-------------------------------------------------------------------------------------------------");
        System.out.println(String.format("%-27s %-15s %-18s %-25s %-15s", "Region", "Country Code","City Name", "District", "Population"));
        System.out.println();
        System.out.println("-------------------------------------------------------------------------------------------------");
        // Loop over all cities in the list
    ...
    public void printCityCountry(ArrayList<City> cityCountry)
    {
        // Print header
        System.out.println("-------------------------------------------------------------------------------------------------");
        System.out.println(String.format("%-27s %-15s %-18s %-25s %-15s", "Country", "Country Code","City Name", "District", "Population"));
        System.out.println();
        System.out.println("-------------------------------------------------------------------------------------------------");
        // Loop over all cities in the list
    ...
    public void printCityDistrict(ArrayList<City> cityDistrict)
    {
        // Print header
        System.out.println("-------------------------------------------------------------------------------------------------");
        System.out.println(String.format("%-27s %-15s %-18s %-25s", "District", "Country Code","City Name", "Population"));
        System.out.println();
        System.out.println("-------------------------------------------------------------------------------------------------");
        // Loop over all cities in the list
